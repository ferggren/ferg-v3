  ...
  _getNavigation() {
    ...
    return [
      ...
      },
      {
        ...
        current: url.match(/^\/(?:ru|en)\/notes/),
        align:   'left',
        link:    '/' + this.props.lang + '/notes/',
      },
      {
        name:    Lang.get('site-nav.moments'),
        current: url.match(/^\/(?:ru|en)\/moments/),
        align:   'left',
        link:    '/' + this.props.lang + '/moments/',
      },
      {
        name:    Lang.get('site-nav.portfolio'),
        current: url.match(/^\/(?:ru|en)\/portfolio/),
        align:   'left',
        link:    '/' + this.props.lang + '/portfolio/',
      },
      {
